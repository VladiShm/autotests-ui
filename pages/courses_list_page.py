...
class CoursesListPage(BasePage):
    ...
    def check_visible_course_card(self, index: int, title: str, max_score: int, min_score: int, estimated_time: str):
        ...
        expect(self.course_min_score_text.nth(index)).to_have_text(f'Min score: {max_score}')
